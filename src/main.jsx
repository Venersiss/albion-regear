...
function publicDate(value, withTime = false) {
  ...
  return new Intl.DateTimeFormat(undefined, withTime ? { weekday: 'short', month: 'short', day: 'numeric', year: 'numeric', hour: 'numeric', minute: '2-digit' } : { weekday: 'short', month: 'short', day: 'numeric', year: 'numeric' }).format(new Date(value))
}
...
function PublicMemberHistoryPaginated({ member }) {
  ...
  const [calendarMonth, setCalendarMonth] = useState(() => new Date(firstHistoryDate.getFullYear(), firstHistoryDate.getMonth(), 1))
  ...
  const changeMonth = (amount) => setCalendarMonth((current) => new Date(current.getFullYear(), current.getMonth() + amount, 1))
